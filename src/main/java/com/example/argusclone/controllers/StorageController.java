...
public class StorageController {
    ...
    @PostMapping
    public ResponseEntity<String> uploadMaterialFile(@PathVariable Integer courseId,
        ...
        storageService.uploadFile(courseId, file);
        return ResponseEntity.ok("Material file uploaded successfully!");
    }
}
